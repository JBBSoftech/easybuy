...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/easybuy_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6953912ec369cd49b17c5198',
      shopName: 'easybuy',
...
app.listen(PORT, () => {
  console.log(`easybuy Backend Server running on port ${PORT}`);
});
